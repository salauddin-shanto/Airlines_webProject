...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="update_info.css">
</head>
...
<body>  
    <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql="UPDATE admin SET name = '$name', phone = '$phone', email='$email', password='$password', nid='$nid', dob='$dob', address='$address', post_code='$post_code'
                where id=1";
    ...
    <section id="page_margin">
        ...
        <section id="header">
            ...
            <div>
                <ul class="navigate">
                    <li><a href="admin.php" > Back to Admin? Click Here! </a></li>
                </ul>
            </div>
        </section>
